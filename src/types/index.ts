...
export interface QuizSession {
  ...
  // Live quizzes carry ShuffledQuestion (with `shuffledChoices`); questions
  // rehydrated from an older saved history may be plain Question. Components
  // discriminate with `'shuffledChoices' in question`.
...
/** Passing score as a whole percentage (e.g. 80), for UI thresholds/labels. */
export const PASS_PERCENTAGE = QUIZ_CONFIG.passingScore * 100;
